...
# override with -g cmdline parameter
	$(Q) cd html_compressed; find . | $(THISDIR)/espfs/mkespfsimage/mkespfsimage -g "jpg,png,ico,gif,html,css,js,svg" > $(THISDIR)/webpages.espfs; cd ..;
else
	$(Q) cd ../html; find . | $(THISDIR)/espfs/mkespfsimage/mkespfsimage -g "jpg,png,ico,gif,html,css,js,svg" > $(THISDIR)/webpages.espfs; cd ..
endif
